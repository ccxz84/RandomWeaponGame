...
다음의 옵션으로 Visual Studio 2017 설치
...
솔루션 탐색기에서 다음 항목을 찾아 우클릭 후, 빌드 진행
...
다음의 옵션으로 Visual Studio 2022 Build Tools 설치 ( 설치 시, 경로를 Program File이 아닌 띄어쓰기가 없이 영어로만 되어있는 경로로 바꿀 것.)
